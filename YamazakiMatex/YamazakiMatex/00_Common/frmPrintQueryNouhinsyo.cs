...
namespace Common
{
    ...
    /// メッセージ出力クラス
    /// </summary>
    public partial class frmPrintQueryNouhinsyo : Common.ChildBaseForm
    {
        #region 変数宣言
        /// <summary>
        /// メッセージ区分
        ...
        /// コンストラクタ
        /// </summary>
        public frmPrintQueryNouhinsyo(MessageType mType, string msg, string printName)
        {
            InitializeComponent();
            ...
            pnlDeliveryPreviewType.Location = new Point(pnlDeliveryPreviewType.Location.X, pnlDeliveryPreviewType.Location.Y + ((addLabelCount - 1) * lblMessageBase.Height));
            pnlDeliveryPrintType.Location = new Point(pnlDeliveryPrintType.Location.X, pnlDeliveryPrintType.Location.Y + ((addLabelCount - 1) * lblMessageBase.Height));
        ...
        {
            ClosedResult = ClosedType.ProvisionalPreview;
            closedForm();
        }
        #endregion

        #region 本伝プレビューボタン押下イベント
        /// <summary>
        /// 本伝プレビューボタン押下イベント
        /// </summary>
        /// <param name="sender"></param>
        ...
        {
            ClosedResult = ClosedType.FormalPreview;
            closedForm();
        }
        #endregion

        #region 仮伝印刷ボタン押下イベント
        /// <summary>
        /// 仮伝印刷ボタン押下イベント
        /// </summary>
        /// <param name="sender"></param>
        ...
        {
            ClosedResult = ClosedType.ProvisionalPrint;
            closedForm();
        }
        #endregion

        #region 本伝印刷ボタン押下イベント
        /// <summary>
        /// 本伝印刷ボタン押下イベント
        /// </summary>
        /// <param name="sender"></param>
        ...
        {
            ClosedResult = ClosedType.FormalPrint;
            closedForm();
        }
        #endregion
